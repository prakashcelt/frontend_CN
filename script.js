...
fetch('http://www.omdbapi.com/?i=tt3896198&apikey=97d78643')
    .then(res => res.json())
        ...
        <div class="fav-item">
            ...
            <div class="fav-details">
                <div class="fav-details-box">
                    ...
                    <div>
                        <i class="fa-regular fa-star" style="cursor:pointer;" onClick=addTofavorites('${id}')></i>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="fav-details">
                <div class="fav-details-box">
                    ...
                    <div style="color: maroon">
                        <i class="fa-regular fa-star" style="cursor:pointer;" onClick=removeFromfavorites('${Id}')></i>
                    </div>
                </div>
            </div>
        </div>
